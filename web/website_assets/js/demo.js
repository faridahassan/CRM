...
(function ($) {
  ...
  function initRangeSliders() {
     ...
     * and options see https://github.com/IonDen/ion.rangeSlider
     ==============================================================*/
    var $rangeArea = $("#form_area");
    var $rangeLandArea = $("#form_landarea");
    var $rangePrice = $("#range_price");
    var $rangeRoom = $("#form_rooms");
    ...
    if ($rangeArea.length ) {
     ...
     if ($rangeLandArea.length ) {
      $rangeLandArea.ionRangeSlider({
        type: "double",
        min: 0,
        max: 2000,
        hide_min_max: true,
  ...
  function generateMarkerHTML(data) {
    ...
    return "<span class='map__address'>" + data.address +
      ...
      "<dl><dt>Area:</dt> <dd>" + data.landarea + " m2</dd></dl>" +
